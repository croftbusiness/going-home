                  ...
                  {formData.medicalInfo.conditions.map((condition, index) => (
                    <div key={index} className="flex items-center space-x-2">
                      <input
                        ...
                        className="flex-1 px-3 sm:px-4 py-2.5 sm:py-3 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#A5B99A] focus:border-transparent text-sm sm:text-base"
                      />
                      <button
                        type="button"
                        onClick={() => removeCondition(index)}
                        className="p-2 text-[#2C2A29] opacity-60 hover:opacity-100 hover:bg-gray-100 rounded-lg transition-colors touch-target"
                      >
                    ...
                    <div key={index} className="p-3 sm:p-4 bg-[#FAF9F7] rounded-lg border border-gray-200/30 space-y-3">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <input
                          ...
                          className="px-3 sm:px-4 py-2.5 sm:py-3 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#A5B99A] focus:border-transparent text-sm sm:text-base"
                        />
                        <input
                          type="text"
                  ...
                  {formData.medicalContacts.map((contact, index) => (
                    <div key={index} className="p-3 sm:p-4 bg-[#FAF9F7] rounded-lg border border-gray-200/30 space-y-3">
                      ...
                      <input
                        ...
                        placeholder="Specialty (e.g., Primary Care, Cardiologist)"
                        className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#A5B99A] focus:border-transparent text-sm sm:text-base"
                      />
                      <input
                        type="tel"
